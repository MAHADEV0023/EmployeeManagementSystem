...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and()
                ...
                .antMatchers(HttpMethod.GET,"/employeerole/{id}").hasAnyAuthority("ADMIN","MANAGER")
                .antMatchers(HttpMethod.GET,"/employeerole").hasAnyAuthority("ADMIN","MANAGER")
                .antMatchers(HttpMethod.PUT,"/employeerole/{id}").hasAnyAuthority("ADMIN","MANAGER")
                .antMatchers(HttpMethod.POST,"/employeerole").hasAnyAuthority("ADMIN","MANAGER")
